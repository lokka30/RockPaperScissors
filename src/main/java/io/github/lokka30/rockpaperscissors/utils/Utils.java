...
public class Utils {
    ...
    public Utils(RockPaperScissors instance) { this.instance = instance; }

    public List<String> getSupportedServerVersions() { return Arrays.asList("1.15.2", "1.15.1", "1.15", "1.14.4", "1.14.3", "1.14.2", "1.14.1", "1.14", "1.13.2", "1.13.1", "1.13", "1.12.2", "1.12.1", "1.12", "1.11.2", "1.11.1", "1.11", "1.10.2", "1.10.1", "1.10", "1.9.4", "1.9.3", "1.9.2", "1.9.1", "1.9", "1.8.8", "1.8.7", "1.8.6", "1.8.5", "1.8.4", "1.8.3", "1.8.2", "1.8.1", "1.8"); }

    public int getLatestSettingsFileVersion() { return 1; }
    public int getLatestMessagesFileVersion() { return 1; }
    public int getLatestDataFileVersion() { return 1; }

    public String colorize(String msg) { return ChatColor.translateAlternateColorCodes('&', msg); }
    public String prefix(String msg) { return colorize(msg.replaceFirst("%prefix%", instance.messages.get("prefix", "[RPS]"))); }
